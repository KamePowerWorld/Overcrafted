...
import quarri6343.overcrafted.api.item.interfaces.IProcessedOCItem.ProcessType;
...
public enum OCItems {
    ...
    FURNACE(new ProcessedOCItem(Component.text("かまど"), Material.FURNACE, "furnace", 0, ProcessType.CRAFTING, COBBLESTONE)),
    IRON_INGOT(new ProcessedOCItem(Component.text("鉄インゴット"), Material.IRON_INGOT, "iron_ingot", 0, ProcessType.SMELTING, IRON_ORE)),
    MINECART(new ProcessedOCItem(Component.text("トロッコ"), Material.MINECART, "minecart", 0, ProcessType.CRAFTING, IRON_INGOT)),
    PLANK(new ProcessedOCItem(Component.text("木材"), Material.OAK_PLANKS, "plank", 0, ProcessType.CRAFTING, WOOD)),
